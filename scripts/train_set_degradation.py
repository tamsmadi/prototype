...
if __name__ == "__main__":
    input_folder = 'D:/prototype/data/leapGestRecog/train'
    for level in degradation_levels:
        for classes in class_names:
            input_folder = f'D:/prototype/data/leapGestRecog/train/{classes}'
            output_folder = f'D:/prototype/degradation/train/{level}/{classes}'
